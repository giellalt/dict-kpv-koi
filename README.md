# Dictionary for kpv — koi

This repository contains source files for a dictionary from Komi-Zyrian to Komi-Permyak. The content is licensed under the CC-BY-4.0 license.
